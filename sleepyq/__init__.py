...
class Sleepyq:
    ...
    def set_light(self, light, setting, bedId = ''):
        ...
        if light in BED_LIGHTS:
            ...
            r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/foundation/outlet', "put", data)
            return True
        else:
    ...
    def get_light(self, light, bedId = ''):
        ...
        if light in BED_LIGHTS:
            ...
            r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/foundation/outlet')
    ...
    def preset(self, preset, side, bedId = '', slowSpeed=False):
        ...
        if preset in BED_PRESETS:
            ...
            r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/foundation/preset', "put", data)
            return True
        else:
            raise ValueError("Invalid preset")

    def set_sleepnumber(self, side, setting, bedId = ''):
        bedId = default_bed_id(self, bedId)
        #
        # side "R" or "L"
    ...
    def set_favsleepnumber(self, side, setting, bedId = ''):
        ...
        r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/sleepNumberFavorite', "put", data)
        return True

    def get_favsleepnumber(self, bedId = ''):
        r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/sleepNumberFavorite')
    ...
    def stop_motion(self, side, bedId = ''):
        ...
        r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/foundation/motion', "put", data)
        return True

    def stop_pump(self, bedId = ''):
        r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/pump/forceIdle', "put")
        return True

    def foundation_status(self, bedId = ''):
        r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/foundation/status')
        return Status(r.json())

    def foundation_system(self, bedId = ''):
        r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/foundation/system')
        return Status(r.json())

    def foundation_features(self, bedId = ''):
        fs = self.foundation_system(default_bed_id(self, bedId))
    ...
    def set_foundation_position(self, side, actuator, position, bedId = '', slowSpeed=False):
        ...
        r=self.__make_request('/bed/'+default_bed_id(self, bedId)+'/foundation/adjustment/micro', "put", data)
        return True